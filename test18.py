...
class SensorApp:
    def __init__(self, master):
        ...
        self.canvas = tk.Canvas(master, width=800, height=600, bg='white')  # Ajustez la taille selon vos besoins
        self.canvas.pack()

        # Charger et afficher l'image d'arrière-plan
        self.background_image = load_and_resize_image("C:/Users/rabou/Desktop/projetdomo/sphère-1024x1024.png", 800, 600)  # Remplacez par le chemin de votre image
        ...
        self.action_button = tk.Button(master, text="Etat de potager", command=self.execute_actions)
        self.action_button.place(x=50, y=250)  # Ajustez la position selon vos besoins

        # Widget Text pour afficher les actions
        self.action_text = scrolledtext.ScrolledText(master, width=50, height=10)
