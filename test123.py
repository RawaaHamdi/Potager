...
class SensorApp:
    def __init__(self, master):
        ...
        self.background_image = load_and_resize_image("C:/Users/rabou/Desktop/projetdomo/sphère-1024x1024.png", 200, 150)  # Réduire la taille de l'image
        self.canvas.create_image(600, 0, anchor=tk.NW, image=self.background_image)  # Déplacer vers la droite
        ...
        # Bouton pour exécuter les actions au centre
        self.action_button = tk.Button(master, text="État de potager", command=self.execute_actions)
        self.action_button.place(relx=0.5, rely=0.5, anchor=tk.CENTER)  # Placer au centre
